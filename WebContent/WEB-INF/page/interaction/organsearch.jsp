                ...
                <tr>
                    <td width="750" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="di_line">
                                    <span class="red_bt" style="margin: 20px;font-size: 18px;">单位：<s:property value="name"/></span>
                                </td>
                            </tr>
                            <tr>
                                <s:if test="!hasOrgan">
                                    <td class="zyd_line" align="center">
                                        <span class="red_bt" style="margin: 20px;font-size: 18px;">单位不存在</span>
                                    </td>
                                </s:if>
                                <s:else>
                                    <td class="zyd_line">
                                            ...
                                            <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                                                <s:iterator value="interactions">
                                                    <tr bgcolor="#F9F9F9">
                                                        ...
                                                        <td width="110" class="xu_di_line"><div align="center" class="hui"><s:property value="organ.name"/></div></td>
