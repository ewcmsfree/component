    ...
    <head>
        ...
        <script type="text/JavaScript">
        	function jumpPage(obj){
            	...
            	window.location = ' <s:url action="working"/>?workingId=<s:property value="workingId"/>&parentId=<s:property value="parentId" escape="false"/>&pageNumber=' + page ;
        	}
        </script>
    </head>
                            ...
                            <tr>
                                <td valign="top" background="images/images/wsbs_kuang_r2_c1.jpg"><div align="center">
                                        <table width="95%"  border="0" cellspacing="2" cellpadding="2">
                                            <tr>
                                                <td height="38" background="images/gmbs_icon.jpg">
                                                    <div align="left" style="padding-left:70px;">
                                                        <span class="red_bt"><strong><s:property value="parent.name"/>&nbsp;&nbsp;｜</strong></span>
                                                        <s:iterator value="parents">
                                                            <s:url action="working" id="url" escapeAmp="false">
                                                                <s:param name="parentId" value="id"/>
                                                            </s:url>
                                                            ・<a href="<s:property value="url"/>" class="hui"><s:property value="name"/></a>&nbsp;
                                                        </s:iterator>
                                                        <s:url action="organ" id="url" escapeAmp="false">
                                                        </s:url>
                                                        ・<a href="<s:property value="url"/>" class="hui">办事单位</a>&nbsp;
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <s:iterator value="workings" status="st">
                                                            <s:if test="(#st.index % 6) == 0">
                                                                ...
                                                                <s:if test="id == null">
                                                                    ...
                                                                    <td height="27">
                                                                        <div align="left">
                                                                            <s:url action="working" id="aurl" escapeAmp="false">
                                                                                <s:param name="parentId" value="%{parent.id}"/>
                                                                                <s:param name="workingId" value="id"/>
                                                                            </s:url>
                                                                            <a href="<s:property value="aurl"/>" class="hui">
                            ...
                            <tr>
                                <td background="images/images/wsbszs_kuang_r1_c1.jpg">
                                    <div align="left" style="padding-left: 30px;"><span class="hui style15">
                                            <strong><s:property value="working.name"/></strong>
                                        </span></div>
                                </td>
