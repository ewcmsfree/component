  ...
  <body>
    ...
    <div id="whole_bg">
      <div id="content">
        ...
        <div class="wsbs_main">
          <div class="current_position"><p><span><strong>当前位置：</strong><a href="/">首页</a>＞<a href="<s:url value='/online/index.html'/>">在线服务</a>＞部门办事</span></p></div>
          ...
          <div class="detail_list">
            <div class="detail_son">
              ...
              <ul class="bs_list">
                ...
                <s:if test="id!=null">
                <li>
                  <s:url value="/online/organ/%{id}.html" id="aurl" escapeAmp="false"/>
