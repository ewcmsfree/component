...
<link href="<s:url value='/css/ruichang.css'/>" rel="stylesheet"
	type="text/css" />
<script src="<s:url value='/Scripts/swfobject_modified.js'/>"
	type="text/javascript"></script>
<script src="<s:url value='/js/changdiv.js'/>" type="text/javascript"></script>
<script type="text/javascript"
	src="<s:url value='/source/js/jquery-1.4.2.min.js'/>"></script>
<script language="JavaScript" type="text/javascript"
	src="<s:url value="/datepicker/WdatePicker.js"/>"></script>
<script type="text/javascript">
	function jumpPage(obj) {
		var page = obj.options[obj.selectedIndex].text - 1;
		window.location = '<s:url action="/component/online/advquery.do"/>?isContent=<s:property value="isContent"/>&title=<s:property value="title"/>&beginDate=<s:property value="beginDate"/>&endDate=<s:property value="endDate"/>&pageNumber='
				+ page;
	}
</script>
</head>
		...
		<div id="content">
			...
			<div class="banjiangonshi">
				<div class="current_position">
					<s:form namespace="/online" action="advquery" method="post"
						name="advqueryform" id="advqueryform">
						...
						<span class="red"><strong>发布日期<input type="text"
								name="beginDate" class="Wdate"
								onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" /> 至
						</strong></span>
						<input type="text" name="endDate" class="Wdate"
							onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
						<img src="images/search.gif" width="51" height="25"
							onclick="document.advqueryform.submit();" />
					</s:form>
				</div>
				<div class="gs_list1">
					<table width="100%">
						...
						<tr>
							<s:iterator value="articles">
								<tr>
									<td height="25" align="left" bgcolor="#FAFAFA"><a
										href="<s:property value="url"/>" target="_blank"><span
											class="news"><s:property value="title" /></span></a></td>
									<td height="25" align="center" bgcolor="#FAFAFA"><s:property
											value="channelName" /></td>
									<td height="25" align="center" bgcolor="#FAFAFA"><s:property
											value="published" /></td>
								</tr>
							</s:iterator>
